...
class ProviderManager @Inject constructor(
    ...
    fun availableProviders(): List<ProviderInfo> = listOf(
        ...
        ProviderInfo("gemini", "Google (Gemini)", "gemini-3-flash-preview",
            ...
            models = listOf("gemini-3-flash-preview", "gemini-3.1-pro-preview", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-pro", "gemini-2.0-flash", "gemini-2.0-flash-lite")),
